...
public class PlayGameScreen extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g.setColor(new Color(135, 206, 235)); //color for the blue sky
		g.fillRect(0, 0, screenWidth, screenHeight*7/8); //create the sky rectangle
		g.setColor(new Color(91, 37, 22)); //brown color for ground
	 ...
	 * @param message The message to parse will be "Game Over" when the game ends
	 */
