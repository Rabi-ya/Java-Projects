...
public class Bird {
	...
	/**
	 * Default constructor-used to set the size of the flappy bird image object
	 */
	...
	/*getter & setter methods for the flappyBird Image object, the x and y location,
	 and the width and height of the bird*/
	/**
	...
	/**
	 * Method to acquire a BufferedImage that represents the Bird's image object- using this buffered image is just more
	 * efficient bc when the buffered image is created, the image data is stored in memory
