...
public class BottomPipe {
	 ...
	 * draw the flappyBird image at the top left corner of the BufferedImage that is created
	...
	public BufferedImage getBI() {
		...
		g.drawImage(bottomPipe, 0, 0, null); //image is being drawn at the origin (0, 0) of the BufferedImage object
		g.dispose();
		return bi;
	}
}